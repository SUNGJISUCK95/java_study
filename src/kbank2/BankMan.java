...
public class BankMan {
	...
	//10
	String name; //은행직원
	AccountPaperVo accountPaper; //은행직원은 고객의 입출금용지 정보가 필요함
...
//					        (입출금 용지이니 x100)		   (hong이니 주소값 x300)
		...
		if(accountPaper.getName() == null ) {
			...
			System.out.println("[은행직원:" + name + "] 계좌번호을 입력해주세요");
		}else if(accountPaper.getPassword() == null) {
			System.out.println("[은행직원:" + name + "] 패스워드을 입력해주세요");
	 ...
	 */
	public void showAccountList() { //15
		System.out.println("==============================");
	 ...
	 */
	public AccountVo[] creatAccountList() { //14
